...
<article id="panel<?php echo $twentyseventeencounter; ?>" <?php post_class( 'twentyseventeen-panel ' ); ?> >
	...
	<?php 
		if(get_field('background_image')) {
			$bg = " style=\"background-image:url('" . get_field('background_image')['url'] . "'); background-repeat: no-repeat; background-size: cover; color:white;\" ";
		} else {
			$bg = "";
		}
	?>
	<div class="panel-content" <?php echo $bg; ?>>
		<div class="wrap">
